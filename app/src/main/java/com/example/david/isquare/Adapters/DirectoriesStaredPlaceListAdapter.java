...
public class DirectoriesStaredPlaceListAdapter extends ArrayAdapter{
    ...
    private DirectoriesStaredPlacesFragment myFragment;

    private Typeface iconFont;

    public void setMyFragment(DirectoriesStaredPlacesFragment myFragment) {
        this.myFragment = myFragment;
    }

    public DirectoriesStaredPlaceListAdapter(@NonNull Context context, @LayoutRes int resource) {
