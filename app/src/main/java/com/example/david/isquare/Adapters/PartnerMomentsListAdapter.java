...
public class PartnerMomentsListAdapter extends ArrayAdapter {
    ...
    private MomentsPartnerFragment myFragment;
    private Typeface iconFont;

    public void setMyFragment(MomentsPartnerFragment myFragment) {
        this.myFragment = myFragment;
    }

    public PartnerMomentsListAdapter(@NonNull Context context, @LayoutRes int resource) {
