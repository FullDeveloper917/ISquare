...
public class GroupChatListAdapter extends ArrayAdapter<ChatContent> {
    ...
    private GroupChatFragment myFragment;

    public enum RowType {
        TEXT, VOICE, IMAGE, CONTACT, ITEM, LOCATION, TRANSFER, SHARE_LOCATION, GROUP
    }

    public void setMyFragment(GroupChatFragment myFragment) {
        this.myFragment = myFragment;
    }

    public GroupChatListAdapter(Context context, List<ChatContent> items) {
