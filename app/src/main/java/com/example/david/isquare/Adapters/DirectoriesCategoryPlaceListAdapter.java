...
public class DirectoriesCategoryPlaceListAdapter extends ArrayAdapter{
    ...
    private DirectoriesCategoryPlacesFragment myFragment;

    private Typeface iconFont;

    public void setMyFragment(DirectoriesCategoryPlacesFragment myFragment) {
        this.myFragment = myFragment;
    }

    public DirectoriesCategoryPlaceListAdapter(@NonNull Context context, @LayoutRes int resource) {
