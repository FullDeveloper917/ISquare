...
public class EditPlaceAddImageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_edit_place_add_image, container, false);
    ...
    private void findViews(View view){
        ...
        btnRtn = view.findViewById(R.id.btnRtn_EditPlaceAddImageFrg);
        btnNext = view.findViewById(R.id.btnNext_EditPlaceAddImageFrg);
    ...
    private void setEvents(){
        btnRtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                myActivity.getSupportFragmentManager().beginTransaction().replace(R.id.frgMain, myActivity.editPlaceFragment).commit();
            }
        });
