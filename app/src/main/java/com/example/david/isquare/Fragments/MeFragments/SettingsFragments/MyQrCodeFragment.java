...
public class MyQrCodeFragment extends Fragment {
    ...
    private void findViews(View view){
        ...
        txtIconRtn = view.findViewById(R.id.txtIconRtn_MyQrCodeFrg);
        imgQrCode = view.findViewById(R.id.imgQrCode_MyQrCodeFrg);
        layoutRtn = view.findViewById(R.id.layoutRtn_MyQrCodeFrg);
    ...
    private void setEvents(){
        ...
        imgQrCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                myActivity.getSupportFragmentManager().beginTransaction().replace(R.id.frgMain, myActivity.profileFragment).commit();
            }
        });
