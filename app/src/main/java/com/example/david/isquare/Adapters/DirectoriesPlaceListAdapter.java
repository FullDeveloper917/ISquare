...
public class DirectoriesPlaceListAdapter extends ArrayAdapter{
    ...
    private DirectoriesFragment myFragment;

    private Typeface iconFont;

    public void setMyFragment(DirectoriesFragment myFragment) {
        this.myFragment = myFragment;
    }

    public DirectoriesPlaceListAdapter(@NonNull Context context, @LayoutRes int resource) {
