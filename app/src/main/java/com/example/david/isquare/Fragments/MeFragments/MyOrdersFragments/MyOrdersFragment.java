...
public class MyOrdersFragment extends Fragment {
    ...
    private void setInit(){
        ...
        orderListAdapter = new MyOrderListAdapter(myActivity, R.layout.list_item_of_orders);
    ...
    private void findViews(View view){
        ...
        txtIconRtn = view.findViewById(R.id.txtIconRtn_MyOrdersFrg);
        layoutRtn = view.findViewById(R.id.layoutRtn_MyOrdersFrg);
        listViewOrders = view.findViewById(R.id.listOrders_MyOrdersFrg);
