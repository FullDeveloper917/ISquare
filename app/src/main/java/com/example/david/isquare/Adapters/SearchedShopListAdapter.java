...
public class SearchedShopListAdapter extends ArrayAdapter {
    ...
    private ShopSearchFragment myFragment;

    private Typeface iconFont;

    public void setMyFragment(ShopSearchFragment myFragment) {
        this.myFragment = myFragment;
    }

    public SearchedShopListAdapter(@NonNull Context context, @LayoutRes int resource) {
