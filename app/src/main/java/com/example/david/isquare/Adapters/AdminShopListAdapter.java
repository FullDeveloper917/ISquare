...
public class AdminShopListAdapter extends ArrayAdapter<ContactItem> {
    ...
    private AdminShopsFragment myFragment;

    public void setMyFragment(AdminShopsFragment myFragment) {
        this.myFragment = myFragment;
    }

    public AdminShopListAdapter(Context context, List<ContactItem> items) {
