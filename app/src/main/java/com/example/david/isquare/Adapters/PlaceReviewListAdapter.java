...
public class PlaceReviewListAdapter extends ArrayAdapter{
    ...
    private PlaceReviewsFragment myFragment;

    private Typeface iconFont;

    public void setMyFragment(PlaceReviewsFragment myFragment) {
        this.myFragment = myFragment;
    }

    public PlaceReviewListAdapter(@NonNull Context context, @LayoutRes int resource) {
    ...
    public View getView(int position, final View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.list_item_of_place_reviews, parent, false);
