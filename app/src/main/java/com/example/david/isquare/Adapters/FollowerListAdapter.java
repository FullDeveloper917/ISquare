...
public class FollowerListAdapter extends ArrayAdapter<ContactItem> {
    ...
    private FollowersFragment myFragment;

    public void setMyFragment(FollowersFragment myFragment) {
        this.myFragment = myFragment;
    }

    public FollowerListAdapter(Context context, List<ContactItem> items) {
