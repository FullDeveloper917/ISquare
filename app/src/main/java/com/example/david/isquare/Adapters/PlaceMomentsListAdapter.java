...
public class PlaceMomentsListAdapter extends ArrayAdapter {
    ...
    private PlaceMomentsFragment myFragment;

    private Typeface iconFont;

    public void setMyFragment(PlaceMomentsFragment myFragment) {
        this.myFragment = myFragment;
    }

    public PlaceMomentsListAdapter(@NonNull Context context, @LayoutRes int resource) {
