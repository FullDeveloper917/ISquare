...
public class ProfileMomentListAdapter extends ArrayAdapter {
    ...
    public void setMyFragment(ProfileFragment myFragment) {
        this.myFragment = myFragment;
    }

    public ProfileMomentListAdapter(@NonNull Context context, @LayoutRes int resource) {
    ...
    public View getView(int position, final View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.list_item_of_moments, parent, false);

        iconFont = FontManager.getTypeface(context, FontManager.FONTAWESOME);
        FontManager.setFontType(rowView.findViewById(R.id.layoutMain_OneMoments), iconFont);
    ...
    private void findViews(View view){
        imgMoment = view.findViewById(R.id.imgMoment_OneMoments);
        btnMenu = view.findViewById(R.id.btnMenu_OneMoments);
        btnLove = view.findViewById(R.id.btnLove_OneMoments);
        btnComment = view.findViewById(R.id.btnComment_OneMoments);
        btnStar = view.findViewById(R.id.btnStar_OneMoments);
        layoutPartner = view.findViewById(R.id.layoutPartner_OneMoments);
        layoutMenu = view.findViewById(R.id.layoutMenu_OneMoments);
        layoutMenuFollowOrUnfollow = view.findViewById(R.id.layoutMenuFollowOrUnfollow_OneMoments);
        txtIconMenuFollowOrUnfollow = view.findViewById(R.id.txtIconMenuFollowOrUnfollow_OneMoments);
        txtMenuFollowOrUnfollow = view.findViewById(R.id.txtMenuFollowOrUnfollow_OneMoments);
        layoutMenuReport = view.findViewById(R.id.layoutMenuReport_OneMoments);
    }
    ...
    private void setEvents(View view, int position){
        ...
        layoutMenuReport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ReportMessageFragment reportMessageFragment = myFragment.getMyActivity().reportMessageFragment;
                myFragment.getMyActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frgMain, reportMessageFragment).commit();
            }
        });
        ...
        layoutPartner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MomentsFragment momentsFragment = myFragment.getMyActivity().momentsFragment;
                myFragment.getMyActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frgMain, momentsFragment).commit();
            }
        });
