...
public class MomentsFollowingListAdapter extends ArrayAdapter {
    ...
    private LinearLayout layoutMenuUnfollow;
    ...
    public MomentsFollowingListAdapter(@NonNull Context context, @LayoutRes int resource) {
    ...
    public View getView(int position, final View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.list_item_of_moments_following, parent, false);

        iconFont = FontManager.getTypeface(context, FontManager.FONTAWESOME);
        FontManager.setFontType(rowView.findViewById(R.id.layoutMain_OneMomentsFollowing), iconFont);
    ...
    private void findViews(View view){
        imgMoment = view.findViewById(R.id.imgMoment_OneMomentsFollowing);
        btnMenu = view.findViewById(R.id.btnMenu_OneMomentsFollowing);
        btnLove = view.findViewById(R.id.btnLove_OneMomentsFollowing);
        btnComment = view.findViewById(R.id.btnComment_OneMomentsFollowing);
        btnStar = view.findViewById(R.id.btnStar_OneMomentsFollowing);
        layoutPartner = view.findViewById(R.id.layoutPartner_OneMomentsFollowing);
        layoutMenu = view.findViewById(R.id.layoutMenu_OneMomentsFollowing);
        layoutMenuUnfollow = view.findViewById(R.id.layoutMenuUnfollow_OneMomentsFollowing);
    }
    ...
    private void setEvents(View view, int position){
        ...
        layoutMenuUnfollow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
